...
manipulate(
  BetaPlot(a,b),
  a = slider(1, 20, step=1, initial = 2, label = "The hyperparameter a in Beta(a,b) density"),
  b = slider(1, 20, step=1, initial = 2, label = "The hyperparameter b in Beta(a,b) density")
)
